import { a as defaultCachePath, d as disguiseHeaders, n as ZEN_BASE_URL, t as ModelCatalog, u as deriveRequestIDs } from "./catalog-BJaRdpHq.js";
...
function makeBridgeHandlers(runtime, settings, deps = {}) {
	return {
		...
		async models() {
			const { staticFreeModels } = await import("./catalog-CP5CuuGt.js");
...
const defaultAssemble = async (config, logger) => {
	const { startIpPool } = await import("./ip-pool-DMFsuZuH.js");
